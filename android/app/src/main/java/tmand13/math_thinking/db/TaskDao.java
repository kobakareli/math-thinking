...
public interface TaskDao {
    ...
    @Query("SELECT task_id as _id, title_en FROM task where title_en LIKE (:titlePrefix) AND " +
    ...
    @Query("SELECT task_id as _id, title_ge FROM task where title_ge LIKE (:titlePrefix) AND " +
            "(has_options = (:hasOptions1) OR has_options = (:hasOptions2)) AND " +
            "(solved = (:solved1) OR solved = (:solved2)) ORDER BY creation_time")
