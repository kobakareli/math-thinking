                ...
                <div class="panel-body">
                    <form method="POST" enctype="multipart/form-data" action="/admin/tasks/update/{{ $task->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="option_1_en" class="hide form-control about-title" placeholder="English optional answer 1" value="{{ $task->option_1_en }}"></input>
                        ...
                        <div class="form-group">
                            ...
                            <input name="option_1_ge" class="hide form-control about-title" placeholder="Georgian optional answer 1" value="{{ $task->option_1_ge }}"></input>
